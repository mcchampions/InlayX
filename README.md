...
| `/gem talisman give <玩家> <保护符ID> [数量]` | 给予保护符(管理员)                                           |
| `/gem talisman list`                          | 查看保护符列表                                               |
| `/gem talisman info`                          | 查看保护符信息                                               |
...
| `inlayx.talisman.list` | 查看保护符列表的权限                   | 所有人 |
| `inlayx.talisman.info` | 查看保护符信息的权限                   | 所有人 |
| `inlayx.talisman.use`  | 应用保护符的权限                       | 所有人 |
...
| `inlayx.talisman.give` | 给予保护符的权限                       | OP     |
